...
MongoDB stores data records as BSON documents. BSON is a binary representation of [JSON](https://www.mongodb.com/docs/reference/glossary/#std-term-JSON) documents, though it contains more data types than JSON. For the BSON spec, see [bsonspec.org](http://bsonspec.org/). See also [BSON Types](https://www.mongodb.com/docs/reference/bson-types/#std-label-bson-types).
...
The value of a field can be any of the BSON [data types](https://www.mongodb.com/docs/reference/bson-types/#std-label-bson-types), including other documents, arrays, and arrays of documents. For example, the following document contains values of varying types:
...
- `_id` holds an [ObjectId](https://www.mongodb.com/docs/reference/bson-types/#std-label-objectid).
...
[Documents](https://www.mongodb.com/docs/core/document/#std-label-bson-document-format) have the following restrictions on field names:
...
- MongodB 5.0 adds improved support for the use of (`$`) and (`.`) in field names. There are some restrictions. See [Field Name Considerations](https://www.mongodb.com/docs/core/dot-dollar-considerations/#std-label-crud-concepts-dot-dollar-considerations) for more details.

- Each field name must be unique within the document. You must not store documents with duplicate fields because MongoDB [CRUD](https://www.mongodb.com/docs/crud/#std-label-crud) operations might behave unexpectedly if a document has duplicate fields.
...
- [`$`](https://www.mongodb.com/docs/reference/operator/update/positional/#mongodb-update-up.-) positional operator for update operations,

- [`$`](https://www.mongodb.com/docs/reference/operator/projection/positional/#mongodb-projection-proj.-) projection operator when array index position is unknown

- [Query an Array](https://www.mongodb.com/docs/tutorial/query-arrays/#std-label-read-operations-arrays) for dot notation examples with arrays.
...
In [time series collections](https://www.mongodb.com/docs/core/timeseries-collections/#std-label-manual-timeseries-collection), documents do not require a unique [_id](https://www.mongodb.com/docs/reference/glossary/#std-term-_id) field because MongoDB does not create an index on the `_id` field.
...
- The `_id` field may contain values of any [BSON data type](https://www.mongodb.com/docs/reference/bson-types/#std-label-bson-types), other than an array, regex, or undefined.
...
- Use an [ObjectId](https://www.mongodb.com/docs/reference/bson-types/#std-label-objectid).
...
In addition to defining data records, MongoDB uses the document structure throughout, including but not limited to: [query filters](https://www.mongodb.com/docs/core/document/#std-label-document-query-filter), [update specifications documents](https://www.mongodb.com/docs/core/document/#std-label-document-update-specification), and [index specification documents](https://www.mongodb.com/docs/core/document/#std-label-document-index-specification)
...
You can use `<field>:<value>` expressions to specify the equality condition and [query operator](https://www.mongodb.com/docs/reference/mql/query-predicates/#std-label-query-projection-operators-top) expressions.
...
Update specification documents use [update operators](https://www.mongodb.com/docs/reference/mql/update/#std-label-update-operators) to specify the data modifications to perform on specific fields during an update operation.
...
For examples, see [Update specifications](https://www.mongodb.com/docs/tutorial/update-documents/#std-label-update-documents-modifiers).
