...
[$elemMatch (projection operator)](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/operator/projection/elemMatch/)

## Definition

`$elemMatch`
The [`$elemMatch`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/operator/query/elemMatch/#mongodb-query-op.-elemMatch) operator matches documents that contain an array field with at least one element that matches all the specified query criteria.

## Compatibility

`$elemMatch`You can use `$elemMatch` for deployments hosted in the following environments:
...
- You cannot specify a [`$where`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/operator/query/where/#mongodb-query-op.-where) operator in an [`$elemMatch`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/operator/query/elemMatch/#mongodb-query-op.-elemMatch).

- You cannot specify a [`$text`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/operator/query/text/#mongodb-query-op.-text) query operator in an [`$elemMatch`](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/reference/operator/query/elemMatch/#mongodb-query-op.-elemMatch).
...
For more information on specifying multiple criteria on array elements, see [Specify Multiple Conditions for Array Elements](https://mongodbcom-cdn.staging.corp.mongodb.com/docs/tutorial/query-arrays/#std-label-specify-multiple-criteria-for-array-elements).
