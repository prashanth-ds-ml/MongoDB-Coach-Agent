> Source: https://www.mongodb.com/docs/manual/tutorial/model-data-for-atomic-operations/
> Fetch method: direct_markdown

# Model Data for Atomic Operations

Although MongoDB supports [multi-document transactions](https://www.mongodb.com/docs/core/transactions/#std-label-transactions) for replica sets and sharded clusters, for many scenarios, the denormalized data model, as discussed on this page, will continue to be optimal for your data and use cases.
...
Then to update with new checkout information, you can use the [`db.collection.updateOne()`](https://www.mongodb.com/docs/reference/method/db.collection.updateOne/#mongodb-method-db.collection.updateOne) method to atomically update both the `available` field and the `checkout` field:
