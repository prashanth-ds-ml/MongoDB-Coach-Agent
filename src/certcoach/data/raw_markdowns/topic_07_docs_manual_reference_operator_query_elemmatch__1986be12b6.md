...
[$elemMatch (projection operator)](https://www.mongodb.com/docs/reference/operator/projection/elemMatch/)

## Definition

`$elemMatch`
The [`$elemMatch`](https://www.mongodb.com/docs/reference/operator/query/elemMatch/#mongodb-query-op.-elemMatch) operator matches documents that contain an array field with at least one element that matches all the specified query criteria.
...
- You cannot specify a [`$where`](https://www.mongodb.com/docs/reference/operator/query/where/#mongodb-query-op.-where) operator in an [`$elemMatch`](https://www.mongodb.com/docs/reference/operator/query/elemMatch/#mongodb-query-op.-elemMatch).

- You cannot specify a [`$text`](https://www.mongodb.com/docs/reference/operator/query/text/#mongodb-query-op.-text) query operator in an [`$elemMatch`](https://www.mongodb.com/docs/reference/operator/query/elemMatch/#mongodb-query-op.-elemMatch).
...
For more information on specifying multiple criteria on array elements, see [Specify Multiple Conditions for Array Elements](https://www.mongodb.com/docs/tutorial/query-arrays/#std-label-specify-multiple-criteria-for-array-elements).
