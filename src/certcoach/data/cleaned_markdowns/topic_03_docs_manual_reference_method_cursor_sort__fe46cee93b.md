...
- Limit the amount of data to sort by using `cursor.limit()` with `cursor.sort()`. See Limit Results for more information and examples.

Memory Limits on Sort Operations
